...
def download_import_team_keys
  ...
  `gpg --homedir /home/backup/ --import /tmp/flexbackupkeys.gpg`
end
...
def generate_gpg_command(filename)
  ...
  encrypt_command =  "gpg --homedir /home/backup/ -e #{emails_as_args} --trust-model always -o /backup/#{filename}.gpg"
